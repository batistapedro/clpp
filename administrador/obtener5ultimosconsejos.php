...
$sql="select nombre_gestion from gestion_social where tipo_gestion='consejo' order by idgestion_social desc limit 0,5";
$sqlver="select count(*) from gestion_social where tipo_gestion='consejo'";
...
<?php
}else if($_SESSION['tipo']=="consejos" || $_SESSION['tipo']=="movimientos" || $_SESSION['tipo']=="comunas" || $_SESSION['tipo']=="concejal"){
$sqlver="select count(*) from gestion_social where tipo_gestion='consejo'";
require("../php/conexion.php");
$base = new Conexion();
$base->conectar();
