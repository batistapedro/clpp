...
$this->Cell(0,10,'Consejo Local De Planificacion Publica, Registros De Las Comunas Socialista, Municipio Heres','T',0,'C');
}
...
$this->Cell(0,5,'Registros De Las Comunas Socialista',0,1,'C');
$this->Ln(3);
...
function cabeceraHorizontal($cabecera)
    {
        ...
        $this->SetTextColor(240, 255, 240); //Letra color blanco
            ...
            $this->CellFitSpace(105,7, utf8_decode($cabecera[0]),1, 0 , 'C', true);
 	    $this->CellFitSpace(50,7,utf8_decode($cabecera[1]),1,0,'C',true);
    ...
    function datosHorizontal($datos)
    {
        ...
        foreach($datos as $fila)
        {
            ...
            $this->CellFitSpace(105,8, utf8_decode($fila['Nombre']),1, 0 , 'C', $bandera );
            $this->CellFitSpace(50,8, utf8_decode($fila['Sector']),1, 0 , 'C', $bandera );
...
$base= new Conexion();
$base->conectar();
$sqlver="select nombre_gestion,sede,sector from gestion_social where parroquia='$parroquia'and tipo_gestion='comuna'";
...
$miCabecera= array('Nombre','Sector','Sede');
$misDatos= array();
...
$sqlver2="select count(*) from gestion_social where parroquia='$parroquia' and tipo_gestion='comuna'";
...
$datos->close();
$base->cerrar();
$pdf->Output("Registros De Las Comunas Por La Parroquia ".$parroquia.".pdf","D");
}
?>
