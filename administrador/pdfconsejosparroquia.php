...
$base= new Conexion();
$base->conectar();
$sqlver="select nombre_gestion,sede,sector from gestion_social where parroquia='$parroquia' and tipo_gestion='consejo'";
...
$misDatos[] = array('Nombre'=>$filas['nombre_gestion'],
'Sector'=>$filas['sector'],
'Sede'=>$filas['sede']
);
}
...
$sqlver2="select count(*) from gestion_social where parroquia='$parroquia' and tipo_gestion='consejo'";
...
$datos->close();
$base->cerrar();
$pdf->Output("Registros De Los Consejos Comunales Por La Parroquia ".$parroquia.".pdf","D");
}
?>
